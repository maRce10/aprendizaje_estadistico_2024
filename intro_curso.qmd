...
::: {.fragment .fade-in}
-   Recuerdo verídico (r = 0.73) y la fuerza de la asociación entre items (r = -0.43) influyen
:::
:::
:::
...
::: {.fragment .fade-in}
<center>$Y: emoción \sim X: asociacion\ entre\ items + recuerdo\ verídico + ...$</center>
:::
...
::: {.fragment .fade-in}
<center>$Y:estrés (binaria) \sim X: género + edad + educación + ...$</center>
:::
